...
INSERT INTO curso (id,nombre,imagen,fecinicio,fectermino,cupos,descripcion) VALUES (3,'JavaScript','https://th.bing.com/th/id/R.1249492264f909cc540ddc8e87419e42?rik=YgSINlEYXUsLjA&pid=ImgRaw&r=0', '2022-06-02','2022-07-02',10,'En este curso aprenderás a utilizar las funciones y las herramientas de JavaScript, para llevar a cabo la elaboración de características interactivas en un sitio web.');
...
INSERT INTO curso (id,nombre,imagen,fecinicio,fectermino,cupos,descripcion) VALUES (5,'Python','https://staging.python.org/static/community_logos/python-powered-h.svg', '2022-06-02','2022-07-02',10,'Este programa especializado está dirigido a aquellas personas que tengan interés por conocer y aprender sobre la programación en Python.');


INSERT INTO estudiante (rut, password,enabled, nombre, telefono,direccion,email,id_region,id_curso,edad) 
VALUES('admin','$2a$12$XiOues3D49riRGEVmaazz.7ykhT.PnQl4L0ofcH5w8kgchPAobUdy',1,'Admin', '98563248','Calle1','die.saavedra001@gmail.com',6,0,18);
